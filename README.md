...
> Yu, Sheng-Jui (2026). Energy-Efficient Path Planning in Winter Conditions: A Comparative Study of Traditional Baseline, Q-learning, and Proximal Policy Optimization in a Grid World Environment. *Convergence Journal*.
